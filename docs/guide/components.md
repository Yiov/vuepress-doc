...
::::: details 如果你要安装注册插件也可以，选其一

:::: code-group
::: code-group-item pnpm
```sh
pnpm add -D @vuepress/plugin-register-components
```
:::
...
::: code-group-item yarn
```sh
yarn add -D @vuepress/utils
```
:::
::: code-group-item npm
```sh
npm i -D @vuepress/utils
```
:::
::::
...
为了更直观的表述，我们直接来使用一个别人写好的vue组件


进度条：[https://themusecatcher.github.io/vue-amazing-ui/](https://themusecatcher.github.io/vue-amazing-ui/)

![](./vuepress-101.png)

在 components 文件夹创建 `Progress.vue`
...
进入仓库：[https://github.com/themusecatcher/vue-amazing-ui/blob/master/packages/progress/Progress.vue](https://github.com/themusecatcher/vue-amazing-ui/blob/master/packages/progress/Progress.vue)
